...
export default function Reponsitoreis() {
  ...
  return (
    <>
          ...
          >
            <div className="flex flex-col gap-2 p-4">
              <div className="flex items-center justify-between">
                <h1 className="truncate mr-2 font-bold text-lg">
                  {card?.name}
                </h1>
                <Badge className={"bg-sky-400"}>
                  {card?.private === false ? "PUBLIC" : "PRIVATE"}
                </Badge>
              </div>
              ...
              <div className="flex items-center gap-1">
                <div
                  className={cn(
                    ...
                    card?.language === "TypeScript" && "bg-sky-600",
                    card?.language === "JavaScript" && "bg-yellow-400",
                    card?.language === "HTML" && "bg-orange-500",
                    card?.language === "CSS" && "bg-blue-500",
                    card?.language === null && "bg-black"
                  )}
                ></div>
                {card?.language || "Empty"}
              </div>
      ...
      <div className="w-full flex items-center justify-center py-6">
        {page < count && (
          <Button
            className="w-[200px] text-sky-600"
            variant="outline"
      ...
      {page > 8 && (
        <Button
          ...
          className="fixed bottom-10 right-10 bg-sky-500"
          size={"icon"}
        >
          <BiSolidArrowToTop className="w-4 h-4" />
        </Button>
      )}
    </>
  );
